...
<body style='background-image: url("background2.png"); background-origin: content-box;  background-position: center; ' >
    ...
    <div id="sidebar-wrapper" style="width: 150px; ">
        <ul class="sidebar-nav" >
              <li ><a href="ShowTicketsTravelPersonnelActive.php">Show Active Tickets</a></li>
              <li ><a href="ShowTicketsTravelPersonnel.php">Show All Tickets</a></li>
              <li ><a href="ReserveTicket.php">Reserve A Ticket</a></li>
            </ul>
        </div>
