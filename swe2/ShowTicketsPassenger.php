...
<div class="container">
                      ...
                      if(isset($_GET['id_resv'])&&($_SESSION['manager_type']==1||isset($_SESSION['telebooker'])))
                        ...
                        {
                        ?>
                       <a class="btn btn-warning" href="DeleteTickets.php?id=<?php  echo $row['Ticket_ID'];?>&id_resv=<?php echo $_GET['id_resv'];?>">Delete</a>
                        
                        <?php
                        }
                        else{
                            ?>
                            <a class="btn btn-warning" href="DeleteTickets.php?id=<?php  echo $row['Ticket_ID']; ;?>">Delete</a>
                            <?php 
