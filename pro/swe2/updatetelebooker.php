...
<div class="container">
             ...
             $manager=new Manager();
             $tele=new TeleBooker();
             $sql=$manager->showTelebooker($tele);
                   ...
                   $pass=$row["Password"];
                    ...
                    $wages=$row["wages"];
                              ...
                              <?php /* <td>password</td>
                                ...
                                <td>bookingNumber</td>
                                <td><div class='input-group input'>
                                <input class='form-control' placeholder='Username' required='' type='text' name='bookingnumber' value=<?php echo $bno ;?>>
                                </div></td>
                                </tr>
                                 <tr>
                                <td>Wages</td>
             ...
             if(isset($_POST["submit"])){
               ...
               // $conpassword=$_POST['confirmpass'];
                ...
                $tele=new TeleBooker();
                if(
                $manager->updateTelebooker($tele,$id,$fname,$mname,$lname,$email,$phone,$telephone,$i,$pass,$streetname,$city,$country,$wages,$bookingnumber)){
                $message="Successful";
                                    echo "<script type='text/javascript'>alert('$message');</script>";
                if(isset($_GET['check'])){echo "<meta http-equiv='Refresh' content='0;URL=TelebookerPanel.php'/>";}else{echo "<meta http-equiv='Refresh' content='0;URL=ShowTelebookers.php'/>";}
            }else{
                  $message="failed";
                                    echo "<script type='text/javascript'>alert('$message');</script>";
            }
