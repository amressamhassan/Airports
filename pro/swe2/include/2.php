...
<body style='background-image: url("background2.png"); background-origin: content-box;  background-position: center; ' >
    ...
    <div id="sidebar-wrapper" style="width: 150px; ">
        <ul class="sidebar-nav" >
           <li ><a href="ReserveTicket.php">Book A ticket</a></li>
              <li ><a href="ShowTicketsPassengerActive.php">Show Active Tickets</a></li>
              <li ><a href="ShowTicketsPassenger.php">Show All Tickets</a></li>
            </ul>
        </div>
